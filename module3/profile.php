...
//to fetch user id from mobile
    $conn = mysqli_connect(DB_HOST, DB_USER, DB_PASS, DB_NAME);
    if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
    }

    $sql = "SELECT id, name FROM user WHERE mobile='$b'";
...
// to fetch mobile number from the user id of the visiting profile
    ...
    $sql="SELECT mobile, name FROM user WHERE id='$nid'";
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <!-- Personal Notification Center Ends here -->
             ...
             ?>
              ...
              <?php
                $sql11 = "SELECT name,email FROM user WHERE id = '$userid'";
                $result11 = $mysqli->query($sql11); 
                $a12 = $result11->fetch_array();
             ?>
              
              
              <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo "$a12[name]";?><b cla   ss="caret"></b></a>
...
<h5 class="buttons"><a class="username" href="currentSale.php?user_r_id=<?php echo $nid ?>">Current Sale</a></h5>
<h5 class="buttons"><a class="username" href="">Broker</a></h5>
<h5 class="buttons b"><a class="username" href="">Favorites</a></h5>
    ...
    $result1 = $mysqli_query($conn,$sql1);   
        ...
        $sql1 = "SELECT id,company_name,area FROM user WHERE mobile = '$b' LIMIT 1";
        $result1 = $mysqli_query($conn,$sql1);    
        $a1 = mysqli_fetch_array($result1);
        $c=$a1['id'];
          */
    ?>
    ...
    <div id="div_1" class="container">
       ...
       <table style="margin-top: -50px;margin-left: 2px;" class="table table-hover">
           ...
           <tr>
               ...
               <td>&nbsp;&nbsp;<?php echo "$a11[name]";?><br>&nbsp;&nbsp;<?php echo "$a11[email]"; ?></td>
           </tr>
           <tr>
