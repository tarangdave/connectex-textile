...
<div class="click">
            ...
            <?php
                $sql10 = "SELECT name FROM user WHERE mobile = '$ub'";
                $result10 = $mysqli->query($sql10); 
                $a10 = $result10->fetch_array();
             ?>
<div class="clickPopUp">
<h4><a class="username" href=""><?php echo "$a10[name]"; ?></a></h4>
<h5 class="buttons"><a class="username" href="profile.php?user_r_id=<?php echo $nid ?>">Profile</a></h5>
<h5 class="buttons"><a class="username">Current Sale</a></h5>
...
<h5 class="buttons b"><a class="username" href="">Favorites</a></h5>
    ...
    <?php
        ...
        $sql1 = "SELECT id,company_name,area FROM user WHERE mobile = '$ub'";
    ...
    <div class="row">
                <div id="div_1" class="container">
                    ...
                    <div id="div_display"><table>
                        ...
                        <tr>
                            <td><span><?php echo "Peak:"?>&nbsp;<?php echo "$a2[peak]"; ?></span></td>
                            <td colspan="2"><span><?php echo "Reed:"?>&nbsp;&nbsp;<?php echo "$a2[fani]"; ?></span></td>
                        </tr>
                        <tr style="border-bottom-style:solid; border-color: white;border-bottom-width: 20px;">
                            <td><span><?php echo "Width:" ?><?php echo "$a2[material_width]"; ?></span></td>
                            <td><span><?php echo "Weight:"?><?php echo "$a2[material_weight]"; ?></span></td>
